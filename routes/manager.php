...
Route::middleware([Kernel::USER_ACCESS, Kernel::JSON_API])->group(
    function () {
        ...
        Route::post('foreign/withdraw-request', [WalletController::class, 'withdrawRequestBatch']);
        Route::get('foreign/withdraw-status', [WalletController::class, 'withdrawStatusBatch']);
