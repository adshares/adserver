...
class CampaignEndsTest extends MailTestCase
{
    public function testBuild(): void
    {
        $campaign = Campaign::factory()->create(['name' => 'Go Adshares']);
        $mailable = new CampaignEnds($campaign);

        $mailable->assertSeeInText('Your campaign, "Go Adshares" will conclude in three days.');
    }
}
