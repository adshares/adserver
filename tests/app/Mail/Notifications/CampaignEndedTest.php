...
class CampaignEndedTest extends MailTestCase
{
    public function testBuild(): void
    {
        $campaign = Campaign::factory()->create(['name' => 'Go Adshares']);
        $mailable = new CampaignEnded($campaign);

        $mailable->assertSeeInText('Your campaign, "Go Adshares" has successfully concluded.');
    }
}
