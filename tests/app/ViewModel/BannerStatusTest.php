...
class BannerStatusTest extends TestCase
{
     ...
     */
    public function testFromString(string $value, BannerStatus $status): void
    {
        self::assertEquals($status, BannerStatus::fromString($value));
    }
    ...
    public function fromStringProvider(): array
    {
        return [
            ...
            ['Draft', BannerStatus::Draft],
            ['DRAFT', BannerStatus::Draft],
            ['rejected', BannerStatus::Rejected],
        ];
    }
}
