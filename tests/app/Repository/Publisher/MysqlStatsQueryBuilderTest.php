...
IFNULL(ROUND(AVG(IF(e.event_type = 'click', e.paid_amount, NULL))), 0) AS rpc,
IFNULL(ROUND(AVG(IF(e.event_type = 'view', e.paid_amount, NULL))), 0)*1000 AS rpm,
SUM(IF(e.event_type IN ('click', 'view'), e.paid_amount, 0)) AS revenue,e.site_id AS site_id FROM network_event_logs e 
