...
final class ServerConfigurationControllerTest extends TestCase
{
    ...
    public function storeDataProvider(): array
    {
        return [
            ...
            'OPEN_RTB_BRIDGE_ACCOUNT_ADDRESS' => [Config::OPEN_RTB_BRIDGE_ACCOUNT_ADDRESS, '0001-00000003-AB0C'],
            'OPEN_RTB_BRIDGE_SERVE_URL' => [Config::OPEN_RTB_BRIDGE_SERVE_URL, 'http://localhost:8015/serve'],
            'OPEN_RTB_BRIDGE_URL' => [Config::OPEN_RTB_BRIDGE_URL, 'http://localhost:8015/info.json'],
