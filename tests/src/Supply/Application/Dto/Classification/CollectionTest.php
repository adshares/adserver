...
final class CollectionTest extends TestCase
{
    ...
    public function testWhenAddingMultipleClassificationsForBanner(): void
    {
        ...
        $collection->addClassification($banner1Id, 'classify:1:1', 'signature#1');
        $collection->addClassification($banner1Id, 'classify:1:1:2', 'signature#2');
        $collection->addClassification($banner1Id, 'classify:2:2:1', 'signature#3');
        $collection->addClassification($banner1Id, 'classify:2:1', 'signature#4');

        $collection->addClassification($banner2Id, 'classify:4:1:1', 'signature#5');
        $collection->addClassification($banner2Id, 'classify:4:1:1', 'signature#6');
