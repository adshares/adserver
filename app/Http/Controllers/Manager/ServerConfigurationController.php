...
class ServerConfigurationController extends Controller
{
    private const VALIDATION_RULES = [
        ...
        Config::CAMPAIGN_EXPERIMENT_MIN_BUDGET => 'nullable|clickAmount',
        Config::CAMPAIGN_EXPERIMENT_MIN_BUDGET_FOR_CPA_REQUIRED => 'nullable|boolean',
        ...
        Config::JOINING_FEE_ENABLED => 'nullable|boolean',
        Config::JOINING_FEE_MIN_VALUE => 'nullable|clickAmount',
        Config::JOINING_FEE_VALUE => 'nullable|clickAmount',
