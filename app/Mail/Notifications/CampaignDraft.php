...
class CampaignDraft extends Mailable
{
    use Queueable;
    ...
    {
        $this->subject = sprintf('Reminder: Your Draft Campaign "%s" Awaits Completion', $this->campaign->name);
        return $this->markdown('emails.notifications.campaign-draft')
            ->with(
                [
