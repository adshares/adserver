...
class NetworkCampaignRepository implements CampaignRepository
{
    ...
    public function save(Campaign $campaign): void
    {
        ...
        foreach ($banners as $domainBanner) {
            ...
            $banner['serve_url'] = UrlProtocolRemover::remove($banner['serve_url']);
            $banner['click_url'] = UrlProtocolRemover::remove($banner['click_url']);
            $banner['view_url'] = UrlProtocolRemover::remove($banner['view_url']);
            unset($banner['id']);
